...
class CursoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cursos2018 = $this->getCursosLocales2018(2015, 'Local');
        $cursos2024 = $this->getCursosLocales2024(2015, 'Local');
    ...
    {   
        return [
            ...
            $this->crearCurso('ASUC00112', $anioMalla,  $tipo, 1, 'Comunicación', 2, 2, 3, 'Obligatorio',
                                ...
                                'ConvalidacionesUC\public\SilabosPDF\Local-ASUC00112-2015.pdf'),
    ...
    private function getCursosPostulantes2015($anioMalla, $tipo): array
    {
        return [
            /* Para los cursos postulantes solo se usarán los campos: 
            $id
            $anioMalla
            $tipo
            $nombre
            ...
            /* El campo estadoCurso, cursoEmparejado y porcentajeSimilitud se completarán luego del proceso de deep learning, 
                los datos siguientes solo simulan el ingreso de datos de cursos postulantes antes del deep learning,
                es decir es el primer paso del proceso de convalidación del sistema web*/
    ...
    private function getCursosPostulantes2018($anioMalla, $tipo): array
    {
        return [
            /* Para los cursos locales solo se usarán los campos: 
            $id
    ...
    private function getCursosPostulantes2024($anioMalla, $tipo): array
    {
        return [
            /* Para los cursos locales solo se usarán los campos: 
            $id
    ...
    private function crearCurso($id, $anioMalla, $tipo, $periodo=null, $nombre, $horasTeoricas = 0, 
                                ...
                                $estado = null, $cursoEmparejado=null, $rutaSilaboPDF=null): array
    {
        return [
            'idCurso'=> $id,
            ...
            'estadoCurso' => $estado,
            'cursoEmparejado' => $cursoEmparejado,
